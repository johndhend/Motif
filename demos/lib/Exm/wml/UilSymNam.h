...
externaldef(uil_sym_glbl) int uil_max_object = 93;
...
externaldef(uil_sym_glbl) int uil_max_arg = 696;
...
externaldef(uil_sym_glbl) int uil_max_reason = 75;
...
externaldef(uil_sym_glbl) int uil_max_enumset = 112;
externaldef(uil_sym_glbl) int uil_max_enumval = 384;
