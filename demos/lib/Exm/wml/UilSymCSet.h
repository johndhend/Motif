...
static unsigned char charset_wrdirection_table_vec[] =
  {
    0,
    0,	/* userdefined */
    XmSTRING_DIRECTION_L_TO_R,	/* XmFONTLIST_DEFAULT_TAG */
    XmSTRING_DIRECTION_L_TO_R,	/* _MOTIF_DEFAULT_LOCALE */
    XmSTRING_DIRECTION_L_TO_R,	/* big5 */
    XmSTRING_DIRECTION_L_TO_R,	/* euc */
    XmSTRING_DIRECTION_L_TO_R,	/* gb_hanzi */
    XmSTRING_DIRECTION_L_TO_R,	/* gb_hanzi_gr */
    XmSTRING_DIRECTION_R_TO_L,	/* iso_arabic */
    XmSTRING_DIRECTION_R_TO_L,	/* iso_arabic_lr */
...
static unsigned char charset_parsdirection_table_vec[] =
  {
    ...
    XmSTRING_DIRECTION_L_TO_R,	/* gb_hanzi_gr */
    XmSTRING_DIRECTION_R_TO_L,	/* iso_arabic */
    XmSTRING_DIRECTION_L_TO_R,	/* iso_arabic_lr */
    XmSTRING_DIRECTION_L_TO_R,	/* iso_cyrillic */
    XmSTRING_DIRECTION_L_TO_R,	/* iso_greek */
    XmSTRING_DIRECTION_R_TO_L,	/* iso_hebrew */
...
static unsigned char charset_charsize_table_vec[] =
  {
    0,
    0,	/* userdefined */
    sym_k_onebyte_charsize,	/* XmFONTLIST_DEFAULT_TAG */
    sym_k_onebyte_charsize,	/* _MOTIF_DEFAULT_LOCALE */
    sym_k_onebyte_charsize,	/* big5 */
    sym_k_onebyte_charsize,	/* euc */
    sym_k_twobyte_charsize,	/* gb_hanzi */
    sym_k_twobyte_charsize,	/* gb_hanzi_gr */
    sym_k_onebyte_charsize,	/* iso_arabic */
    sym_k_onebyte_charsize,	/* iso_arabic_lr */
...
static char *charset_lang_names_table_vec[] =
  {
    ...
    "88596",	/* iso_arabic */
    "ISO_ARABIC_LR",	/* iso_arabic_lr */
    "ISO8859-6",	/* iso_arabic_lr */
    "ISO_LATIN6_LR",	/* iso_arabic_lr */
...
static unsigned short int charset_lang_codes_table_vec[] =
  {
    sym_k_XmFONTLIST_DEFAULT_TAG_charset,
    sym_k_XmFONTLIST_DEFAULT_TAG_charset,
    sym_k__MOTIF_DEFAULT_LOCALE_charset,
    sym_k__MOTIF_DEFAULT_LOCALE_charset,
    sym_k_big5_charset,
    sym_k_big5_charset,
    sym_k_euc_charset,
