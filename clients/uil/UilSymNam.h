...
externaldef(uil_sym_glbl) int uil_max_arg = 684;
...
externaldef(uil_sym_glbl) int uil_max_reason = 74;
...
externaldef(uil_sym_glbl) int uil_max_enumset = 110;
externaldef(uil_sym_glbl) int uil_max_enumval = 378;
